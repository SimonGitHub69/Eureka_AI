...
class Command(BaseCommand):
    help = "Importa le tabelle 4D Valuta e Valuta_Det in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo Valuta/valuta o Valuta_Det/valuta_det.",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_valute(batch_size=batch_size, only=only, full=full)
