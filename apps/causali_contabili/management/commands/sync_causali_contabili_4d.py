...
class Command(BaseCommand):
    help = "Importa la tabella 4D CausaliC (Causali Contabili) in PostgreSQL."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING("Avvio sync CausaliC 4D -> PostgreSQL..."))
        result = sync_causali_contabili(batch_size=batch_size, only=only, full=full)
