...
class Command(BaseCommand):
    help = "Importa la tabella 4D GruppoArt (gruppi articoli) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo GruppoArt/gruppi_articoli (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_gruppi_articoli(batch_size=batch_size, only=only, full=full)
