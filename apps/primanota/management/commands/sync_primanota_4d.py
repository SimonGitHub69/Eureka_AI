...
class Command(BaseCommand):
    help = "Importa le tabelle 4D Primanota e Primanota_Dettaglio in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo una tabella (Primanota o Primanota_Dettaglio).",
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING("Avvio sync Primanota 4D -> PostgreSQL..."))
        result = sync_primanota(batch_size=batch_size, only=only, full=full)
