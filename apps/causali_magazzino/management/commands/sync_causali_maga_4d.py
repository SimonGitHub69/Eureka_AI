...
class Command(BaseCommand):
    help = "Importa la tabella 4D CausaliMaga in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo CausaliMaga/causali_maga (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_causali_magazzino(batch_size=batch_size, only=only, full=full)
