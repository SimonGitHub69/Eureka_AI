...
urlpatterns = [
    ...
    path("carbon/seriali/", seriali_views.seriali_dashboard, name="seriali_dashboard"),
    path("carbon/seriali/api/kpi/", seriali_views.api_kpi, name="seriali_api_kpi"),
    path("carbon/seriali/api/seriali-lista/", seriali_views.api_seriali_lista, name="seriali_api_lista"),
    path("carbon/seriali/api/seriali-stato/", seriali_views.api_seriali_stato, name="seriali_api_stato"),
    path("carbon/seriali/api/seriali-reparto/", seriali_views.api_seriali_reparto, name="seriali_api_reparto"),
    path(
        "carbon/seriali/api/lavorazioni-giorno/",
        seriali_views.api_lavorazioni_giorno,
        name="seriali_api_lavorazioni_giorno",
    ),
    path(
        "carbon/seriali/api/lavorazioni-extra/",
        seriali_views.api_lavorazioni_extra,
        name="seriali_api_lavorazioni_extra",
    ),
    path(
        "carbon/seriali/api/stampi-opzioni/",
        seriali_views.api_stampi_opzioni,
        name="seriali_api_stampi_opzioni",
    ),
    path(
        "carbon/seriali/api/stampi-seriali/",
        seriali_views.api_stampi_seriali,
        name="seriali_api_stampi_seriali",
    ),
    path(
        "carbon/seriali/api/catalogo-extra/",
        seriali_views.api_catalogo_extra,
        name="seriali_api_catalogo_extra",
    ),
    path(
        "carbon/seriali/api/codartser-suggest/",
        seriali_views.api_codartser_suggest,
        name="seriali_api_codartser_suggest",
    ),
    path(
        "carbon/seriali/api/stampi-dettaglio/",
        seriali_views.api_stampi_dettaglio,
