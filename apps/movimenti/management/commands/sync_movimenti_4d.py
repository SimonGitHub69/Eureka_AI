...
class Command(BaseCommand):
    help = "Importa le tabelle 4D MovimentiT e MovimentiT_Dettaglio in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo una tabella (MovimentiT o MovimentiT_Dettaglio).",
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.WARNING("Avvio sync MovimentiT 4D -> PostgreSQL...")
        )
        result = sync_movimenti(batch_size=batch_size, only=only, full=full)
