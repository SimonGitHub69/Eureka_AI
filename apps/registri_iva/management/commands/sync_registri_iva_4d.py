...
class Command(BaseCommand):
    help = "Importa la tabella 4D RegistriIva in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo RegistriIva/registri_iva (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_registri_iva(batch_size=batch_size, only=only, full=full)
