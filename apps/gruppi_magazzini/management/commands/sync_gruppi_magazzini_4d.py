...
class Command(BaseCommand):
    help = "Importa la tabella 4D RaggMagazzini (Gruppi Magazzini) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo RaggMagazzini/gruppi_magazzini (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_gruppi_magazzini(batch_size=batch_size, only=only, full=full)
