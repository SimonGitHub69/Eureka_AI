...
class Command(BaseCommand):
    help = "Importa la tabella 4D Azienda in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo Azienda/aziende (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_aziende(batch_size=batch_size, only=only, full=full)
