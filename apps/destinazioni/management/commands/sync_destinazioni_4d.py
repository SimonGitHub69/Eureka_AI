...
class Command(BaseCommand):
    help = "Importa la tabella 4D DestCliFor (destinazioni diverse) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo DestCliFor.",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_destinazioni(batch_size=batch_size, only=only, full=full)
