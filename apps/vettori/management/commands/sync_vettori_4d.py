...
class Command(BaseCommand):
    help = "Importa la tabella 4D Vettori (spedizionieri) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo Vettori/vettori (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_vettori(batch_size=batch_size, only=only, full=full)
