...
class Command(BaseCommand):
    help = "Importa la tabella 4D CatMerce (categorie merce) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo CatMerce/categorie (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_categorie(batch_size=batch_size, only=only, full=full)
