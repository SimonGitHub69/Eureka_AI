...
class Command(BaseCommand):
    help = "Importa la tabella 4D Operatori in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo Operatori/operatori (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_operatori(batch_size=batch_size, only=only, full=full)
