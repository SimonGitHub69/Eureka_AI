...
class Command(BaseCommand):
    help = "Importa la tabella 4D PDC (Piano dei Conti) in PostgreSQL."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING("Avvio sync PDC 4D -> PostgreSQL..."))
        result = sync_pdc(batch_size=batch_size, only=only, full=full)
