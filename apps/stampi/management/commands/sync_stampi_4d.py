...
class Command(BaseCommand):
    help = "Importa la tabella 4D TabStampi (stampi) in PostgreSQL."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Sincronizza solo TabStampi/stampi (source/target name).",
        )
    ...
    def handle(self, *args, **options):
        ...
        result = sync_stampi(batch_size=batch_size, only=only, full=full)
