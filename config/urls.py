...
urlpatterns = [
    ...
    path("", include("apps.registri_iva.urls")),
    path("", include("apps.banche.urls")),
    path("", include("apps.sconti.urls")),
    path("", include("apps.valute.urls")),
    path("", include("apps.zone.urls")),
    path("", include("apps.vettori.urls")),
    path("", include("apps.causali_trasp.urls")),
    path("", include("apps.destinazioni.urls")),
    ...
    path("", include("apps.causali_magazzino.urls")),
    path("", include("apps.movimenti.urls")),
    ...
    path("", include("apps.primanota.urls")),
